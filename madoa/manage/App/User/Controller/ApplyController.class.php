...
<table align="center" cellspacing="0" cellpadding="0" width="600">
    <tbody>
        ...
        <tr>
            <td style="font-size: 12px; -webkit-font-smoothing: subpixel-antialiased; word-break: break-all; padding-top: 10px; padding-bottom: 10px; border-top-color: rgb(224, 224, 224); ">
                <span style="font-size: 14px; color: rgb(160, 160, 160);">登录<a href="{$loginurl}" target="_blank" style="outline: none; text-decoration: none; cursor: pointer; color: rgb(11, 149, 239); ">周伯通招聘</a>，加入最靠谱的招聘社区。</span><br/><span style="font-size: 14px; color: rgb(160, 160, 160);">如果遇到任何问题，欢迎随时骚扰：<span t="6" data="010-82866096" style="border-bottom-width: 1px; border-bottom-style: dashed; border-bottom-color: rgb(204, 204, 204); z-index: 1;">010-8881234</span></span><br/><span style="font-size: 14px; color: rgb(160, 160, 160);">（系统邮件，请勿直接回复）</span><br/><br/><span style="font-size: 14px; color: rgb(160, 160, 160);">周伯通招聘团队</span>
            </td>
        </tr>
    </tbody>
</table>
...
str;
		...
		if (sendMail($mail, I('title'), $content)) {
			$do    = M("apply");
			$where = array("id" => I('id'), 'comid' => $this->company['id']);
