							...
							<td class="col-xs-3">
								<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
									<button class="btn btn-xs btn-inverse" title="添加子标签" id="addChild"
											data-url="<?php echo U('Tag/add?id='.$v['id']);?>">
										<i class="icon-bookmark-empty bigger-120"></i>
										添加子标签
									</button>
									<button class="btn btn-xs btn-info" title="编辑" id="edit" data-url="<?php echo U('Tag/edit?id='.$v['id']);?>">
										<i class="icon-edit bigger-120"></i>
										编辑
									</button>
									<button class="btn btn-xs btn-danger" title="删除" id="del" data-id="<?php echo ($v["id"]); ?>">
