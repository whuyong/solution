				...
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab">
						<li class="active">
				 		...
				 		<li>
							<a href="<?php echo U('Leaved/addapprove');?>">
		...
		var oTable = $('#sample-table').dataTable({
			...
			"aoColumns" : [ //列操作
				...
				},
				{
					...
					"mData" : "f_id",
					"mRender" : function (data) {
						var editurl = "<?php echo U('Leaved/provedit');?>?id=" + data;
						var delturl = "<?php echo U('Leaved/provdelete');?>?id=" + data;
			...
			"sAjaxSource" : "<?php echo U('Leaved/provelists');?>",
			"sServerMethod" : "POST",
			//"bProcessing": true,
