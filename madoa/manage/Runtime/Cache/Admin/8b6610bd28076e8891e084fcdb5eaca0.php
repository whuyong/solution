			...
			<div class="row">
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab">
						<li class="">
							<a href="<?php echo U('Leaved/index');?>">
					...
					<div class="tab-content">
						<div class="tab-pane in active">
							<form  id="ajaxForm" class="form-horizontal" action="<?php echo U('Leaved/updateapp');?>" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text"  readonly="readonly"  class="col-xs-10 col-sm-5" value="<?php echo ($data["uname"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 申请部门 </label>
									<div class="col-sm-9">
										<input type="text"  readonly="readonly"  class="col-xs-10 col-sm-5" value="<?php echo ($data["cpname"]); ?>"/>
									</div>
								</div>
                                                                <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 类型 </label>
									<div class="col-sm-9">
										<input type="text"  readonly="readonly"  class="col-xs-10 col-sm-5" value="<?php echo ($data["ctname"]); ?>"/>
									</div>
								</div>
                                                                 <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"  > 开始时间 </label>
									<div class="col-sm-9">
										<input type="text"  name="f_start" id="start_time" class="col-xs-10 col-sm-5" value="<?php echo ($data["f_start"]); ?>"/>
									</div>
								</div>
                                                                 <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 结束时间 </label>
									<div class="col-sm-9">
										<input type="text"  name="f_end" id="end_time" class="col-xs-10 col-sm-5" value="<?php echo ($data["f_end"]); ?>"/>
									</div>
								</div>
                                                                <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 总计 </label>
									<div class="col-sm-9">
										<input type="text"  name="f_total" readonly="readonly"  class="col-xs-10 col-sm-5" value="<?php echo ($data["f_total"]); ?>"/>小时
									</div>
								</div>
                                                                 <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 备注信息 </label>
									<div class="col-sm-9">
										<input type="text"  name="f_info"  class="col-xs-10 col-sm-5" value="<?php echo ($data["f_info"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" > 状态</label>
									<div class="col-sm-2">
										<input type="radio" name="f_at" class="ace"
										       <?php if(($data["f_at"]) == "1"): ?>checked<?php else: endif; ?>
												<?php if(($data["status"]) == ""): ?>checked<?php else: endif; ?> value="1"/>
										<span class="lbl"> 已审批 </span>
										<input  type="radio" name="f_at" class="ace"
										<?php if(($data["f_at"]) == "0"): ?>checked<?php else: endif; ?> value="2"/>

										<span class="lbl"> 未审批 </span>
									</div>
								</div>
...
<script type="text/javascript">
	seajs.use([ "admin-common",'$', 'bootstrap3.0', "datetimepiker-css", 'bootstrap-datetime'], function (admin, $) {
           var formstarttime= $("#start_time").datetimepicker({
                fromat : 'yyyy-mm-dd hh:ii:ss',
                autoclose : true,
                todayBtn : true,
                timepicker:true,
                lang:"ch"
             ...
             var formendtime= $("#end_time").datetimepicker({
                fromat : 'yyyy-mm-dd hh:ii:ss',
                autoclose : true,
                todayBtn : true,
                timepicker:true,
