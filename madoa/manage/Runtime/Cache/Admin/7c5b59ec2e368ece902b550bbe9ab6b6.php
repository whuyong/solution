...
<div class="page-content">
	<div class="page-header">
		<h1>
			...
			<small>
				<i class="icon-double-angle-right"></i>
				<?php if((ACTION_NAME) == "edit"): ?>修改用户<?php else: ?>添加用户<?php endif; ?>
			</small>
		</h1>
	</div>
	<!-- /.page-header -->
			...
			<div class="row">
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab">
						...
						<li>
							<a href="<?php echo U('FrontUser/reload');?>">
					...
					<div class="tab-content">
						<div class="row">
							<div class="col-xs-4">
								<form class="form-horizontal" id="ajaxForm" action='<?php if((ACTION_NAME) == "edit"): echo U("FrontUser/update"); else: echo U("FrontUser/insert"); endif; ?>' method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="f_name" value="" class="col-xs-9"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label"> 账号 </label>
										<div class="col-sm-9">
											<input type="text"  name="f_userid" value="" class="col-xs-9"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class=" width-70 form-control cate" name="f_gender" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="f_weixinid" value="" class="col-xs-9"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label"> 手机号 </label>
										<div class="col-sm-9">
											<input type="text"  name="f_mobile" value="" class="col-xs-9"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label"> 邮箱 </label>
										<div class="col-sm-9">
											<input type="text"  name="f_email" value="" class="col-xs-9"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label"> 所在部门 </label>
										<div class="col-sm-9">
											<input type="text"  name="f_title" value="" class="col-xs-9"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label"> 职位 </label>
										<div class="col-sm-9">
											<input type="text"  name="f_department" value="" class="col-xs-9"/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-6">
											<select class=" width-90 form-control cate" name="role_id" >
											<option value="">选择角色</option>
											<?php if(is_array($role)): foreach($role as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if(($role_id) == $v["id"]): ?>selected<?php endif; ?>><?php echo ($v["remark"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									<hr/>
