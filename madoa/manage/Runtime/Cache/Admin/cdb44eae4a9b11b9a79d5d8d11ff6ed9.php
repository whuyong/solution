...
<script type="text/javascript">
    //console.log("<?php echo ($user['f_corpid']); ?>");
		...
		var oTable = $('#sample-table').dataTable({
			...
			"aoColumns" : [ //列操作
				...
				/*{
					...
					"mData" : "f_id",
					"mRender" : function (data) {
						var editurl = "<?php echo U('Leaved/editapp');?>?id=" + data;
						var delturl = "<?php echo U('Leaved/delete');?>?id=" + data;
			...
			"sAjaxSource" : "<?php echo U('Leaved/lists');?>",
			"sServerMethod" : "POST",
			"bProcessing": true,
                        "bStateSave": true,
			//多语言配置
