...
<link rel="stylesheet" type="text/css" href="/madoa/manage/Public/Css/Common/bootstrap-switch.min.css">
			...
			<div class="row">
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab">
						<li class="active">
							<a  href="<?php echo U('Logistics/index');?>">
...
<script type="text/javascript">
	seajs.use(['admin-common','$','dataTables',"dataTables-bootstrap", 'bootbox','bootstrap-switch'],function(admin,$){
		var oTable = $('#sample-table').dataTable({
			...
			"sAjaxSource" : "<?php echo U('Logistics/commentList');?>",
			"sServerMethod" : "POST",
			//"bProcessing": true,
			...
			$("[name='switch']").bootstrapSwitch().on('switchChange', function(e, data) {
				...
				$.ajax({
					url:"<?php echo U('Admin/Logistics/update');?>",
