			...
			<div class="row">
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="row">
							<div class="col-xs-4">
								<form class="form-horizontal" id="ajaxForm" action='<?php if((ACTION_NAME) == "edit"): echo U("Departmant/update"); else: echo U("Departmant/insert"); endif; ?>' method="post">
									<input type="hidden" name="f_id" value="<?php echo ($item["f_id"]); ?>"/>
									<hr/>
									<div class="form-group">
										<label class="col-sm-3 control-label" >上级部门</label>

										<div class="col-sm-9">
											<select class=" width-90 form-control cate" name="f_pid" <?php echo ($disabled); ?> >
												<option value="0">作为主部门</option>
												<?php if(is_array($list)): foreach($list as $key=>$v): ?><option value="<?php echo ($v["f_id"]); ?>|<?php echo ($v["path"]); ?>" <?php echo ($v["selected"]); ?>><?php echo ($v["f_title"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="f_title" value="<?php echo ($item["f_title"]); ?>"/>
										</div>
									</div>
