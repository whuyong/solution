...
window.UEDITOR_HOME_URL = wolf.seajsBase + "libs/ueditor/";
...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ["fullscreen","source","undo","redo","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall","searchreplace","preview","|","insertimage","emotion","insertvideo","date","time","wordimage","map","horizontal","anchor","spechars","blockquote","insertcode","template","touppercase","tolowercase","indent","removeformat","formatmatch","autotypeset","paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter"]
        ]
